...
import resumeFile from "../Ansh Kapoor Resume.pdf";
const Header = () => {
  const svgMarkup = `
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" id="leetcode" width="25" height="25" style="margin-top: 20px;">
      ...
      <div className="header-content">
        <div className="header-title">
          ...
          <nav>
            ...
            <a
              href="https://leetcode.com/ansh28508/"
              target="_blank"
